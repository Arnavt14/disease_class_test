...
for idx in range(len(model_v.layers)):
  print(model_v.get_layer(index = idx).name)


# passing grad cam class
icam = GradCAM(model_v, 'dense')
heatmap = icam.compute_heatmap(resize)
